...
data class GardenPlanting(
        ...
        /**
         * Indica quando a [Plant] foi plantada. Usado para mostrar notificação quando chegar a hora
         * para colher a planta.
         */
        @ColumnInfo(name = "plant_date") val plantDate: Calendar = Calendar.getInstance(),

        /**
         * Indica quando a [Plant] foi regada pela última vez. Usado para mostrar notificação quando é
